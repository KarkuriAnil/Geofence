    ...
    public void onMapLongClick(@NonNull LatLng latLng) {
        if(Build.VERSION.SDK_INT>=29)
        {
            if (ActivityCompat.checkSelfPermission(MapsActivity.this, Manifest.permission.ACCESS_BACKGROUND_LOCATION)==PackageManager.PERMISSION_GRANTED)
            {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(MapsActivity.this, android.Manifest.permission.ACCESS_BACKGROUND_LOCATION)) {
                    // Show a dialog explaining the need for the background location permission
                            ...
                            ActivityCompat.requestPermissions(MapsActivity.this, new String[]{android.Manifest.permission.ACCESS_BACKGROUND_LOCATION}, BACKGROUBD);
